 ...
 * @author YADI
 */
public class halamanRegistrasi extends /*
 * Click nbfs://nbhost/SystemFileSystem/Templates/Licenses/license-default.txt to change this license
 * Click nbfs://nbhost/SystemFileSystem/Templates/GUIForms/JFrame.java to edit this template
 */
...
public class halamanRegistrasi extends javax.swing.JFrame {
    ...
    private void tombolDaftarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tombolDaftarActionPerformed
        ...
        // Validasi Data
        if (nim.isEmpty() || emailValue.isEmpty() || pass.isEmpty() || konfirPass.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Semua field harus diisi!");
            return;
        }

        // Validasi pilihan fakultas
        if (fakultasValue.equals("-- Pilih Fakultas --")) {
        ...
        if (atIndex != -1) {
            nama = emailValue.substring(0, atIndex);
        } else {
            nama = emailValue; 
        }

        // Simpan SEMUA data ke kelas statis DataPengguna
        dataPengguna.nama = nama;
        dataPengguna.nim = nim;
        dataPengguna.fakultas = fakultasValue;
        dataPengguna.email = emailValue;
